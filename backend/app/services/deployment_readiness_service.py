    ...
    gates = [
        ...
        _gate(
            ...
            details={
                ...
                "release_lock_current_hash": data_release_bundle.get("release_lock_current_hash"),
                "release_lock_locked_hash": data_release_bundle.get("release_lock_locked_hash"),
        ...
        _gate(
            ...
            details={
                ...
                "latest_recommendation_linkage_hash": (qc_archive.get("latest_artifacts") or [{}])[0].get("recommendation_linkage_hash"),
                "latest_recommendation_linkage_candidate_id": (qc_archive.get("latest_artifacts") or [{}])[0].get("recommendation_linkage_candidate_id"),
                "latest_recommendation_linkage_status": (qc_archive.get("latest_artifacts") or [{}])[0].get("recommendation_linkage_status"),
        ...
        _gate(
            ...
            details={
                ...
                "release_lock_current_hash": (data_release_archive.get("latest_artifacts") or [{}])[0].get("release_lock_current_hash"),
                "release_lock_locked_hash": (data_release_archive.get("latest_artifacts") or [{}])[0].get("release_lock_locked_hash"),
                "latest_release_lock_current_hash": (data_release_archive.get("latest_artifacts") or [{}])[0].get("release_lock_current_hash"),
                "latest_release_lock_locked_hash": (data_release_archive.get("latest_artifacts") or [{}])[0].get("release_lock_locked_hash"),
