...
def optimizer_benchmark_archive_summary(limit: int = 20, *, verify_files: bool = True) -> dict[str, Any]:
    return _bundle_archive_semantic_summary(
        ...
        extra_fields=(
            ...
            "recommendation_summary_status",
            "recommended_on_pareto_front_count",
            ...
            "recommended_folding_candidate_match_count",
            "structured_manifest_hash",
        ),
    )
...
def rag_regression_archive_summary(limit: int = 20, *, verify_files: bool = True) -> dict[str, Any]:
    return _bundle_archive_semantic_summary(
        ...
        extra_fields=(
            ...
            "source_provenance_source_count",
            "source_snapshot_case_count",
            "top_source_count",
...
def _semantic_metadata(verification: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "report_formats_summary_hash": verification.get("report_formats_summary_hash"),
        ...
        "recommendation_readiness_hash": verification.get("recommendation_readiness_hash"),
        "recommendation_readiness_status": verification.get("recommendation_readiness_status"),
        "recommendation_release_ready": verification.get("recommendation_release_ready"),
        "recommendation_readiness_candidate_id": verification.get("recommendation_readiness_candidate_id"),
        "recommendation_linkage_hash": verification.get("recommendation_linkage_hash"),
        "recommendation_linkage_candidate_id": verification.get("recommendation_linkage_candidate_id"),
        "recommendation_linkage_status": verification.get("recommendation_linkage_status"),
        "candidate_folding_audit_hash": verification.get("candidate_folding_audit_hash"),
        "candidate_folding_audit_selection_signal": verification.get("candidate_folding_audit_selection_signal"),
        "candidate_folding_audit_validated_backend_count": verification.get("candidate_folding_audit_validated_backend_count"),
        ...
        "recommended_folding_candidate_id": verification.get("recommended_folding_candidate_id"),
        ...
        "retrieval_quality_rank_evidence_count": verification.get("retrieval_quality_rank_evidence_count"),
        "retrieval_quality_rank_evidence_hash": verification.get("retrieval_quality_rank_evidence_hash"),
...
def _data_release_semantic_metadata(verification: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "record_source_summary_hash": verification.get("record_source_summary_hash"),
        "dataset_count": verification.get("dataset_count"),
        "release_count": verification.get("release_count"),
        "source_file_count": verification.get("source_file_count"),
...
def _rag_regression_semantic_metadata(verification: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "quality_status": verification.get("quality_status"),
        "source_provenance_summary_hash": verification.get("source_provenance_summary_hash"),
        "source_provenance_case_count": verification.get("source_provenance_case_count"),
        "source_provenance_source_count": verification.get("source_provenance_source_count"),
        "source_snapshot_case_count": verification.get("source_snapshot_case_count"),
...
def _optimizer_benchmark_semantic_metadata(verification: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "recommendation_summary_hash": verification.get("recommendation_summary_hash"),
        "recommendation_summary_status": verification.get("recommendation_summary_status"),
        "recommended_on_pareto_front_count": verification.get("recommended_on_pareto_front_count"),
        "recommendation_max_regret": verification.get("recommendation_max_regret"),
        ...
        "recommended_folding_candidate_match_count": verification.get("recommended_folding_candidate_match_count"),
        "structured_manifest_hash": verification.get("structured_manifest_hash"),
        "checked_files": verification.get("checked_files"),
        "file_count": verification.get("file_count"),
        "manifest_hash": verification.get("manifest_hash"),
...
def _semantic_summary_item_from_metadata(artifact: dict[str, Any]) -> dict[str, Any] | None:
    ...
    return {
        ...
        "report_formats_summary_hash": semantic.get("report_formats_summary_hash"),
        ...
        "recommendation_readiness_hash": semantic.get("recommendation_readiness_hash"),
        "recommendation_readiness_status": semantic.get("recommendation_readiness_status"),
        "recommendation_release_ready": semantic.get("recommendation_release_ready"),
        "recommendation_readiness_candidate_id": semantic.get("recommendation_readiness_candidate_id"),
        "recommendation_linkage_hash": semantic.get("recommendation_linkage_hash"),
        "recommendation_linkage_candidate_id": semantic.get("recommendation_linkage_candidate_id"),
        "recommendation_linkage_status": semantic.get("recommendation_linkage_status"),
        "candidate_folding_audit_hash": semantic.get("candidate_folding_audit_hash"),
        "candidate_folding_audit_selection_signal": semantic.get("candidate_folding_audit_selection_signal"),
        "candidate_folding_audit_validated_backend_count": semantic.get("candidate_folding_audit_validated_backend_count"),
        ...
        "recommended_folding_candidate_id": semantic.get("recommended_folding_candidate_id"),
        ...
        "retrieval_quality_rank_evidence_count": semantic.get("retrieval_quality_rank_evidence_count"),
        "retrieval_quality_rank_evidence_hash": semantic.get("retrieval_quality_rank_evidence_hash"),
...
def _semantic_summary_item_from_verification(artifact: dict[str, Any], verification: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "report_formats_summary_hash": bundle_verification.get("report_formats_summary_hash"),
        ...
        "recommendation_readiness_hash": bundle_verification.get("recommendation_readiness_hash"),
        "recommendation_readiness_status": bundle_verification.get("recommendation_readiness_status"),
        "recommendation_release_ready": bundle_verification.get("recommendation_release_ready"),
        "recommendation_readiness_candidate_id": bundle_verification.get("recommendation_readiness_candidate_id"),
        "recommendation_linkage_hash": bundle_verification.get("recommendation_linkage_hash"),
        "recommendation_linkage_candidate_id": bundle_verification.get("recommendation_linkage_candidate_id"),
        "recommendation_linkage_status": bundle_verification.get("recommendation_linkage_status"),
        "candidate_folding_audit_hash": bundle_verification.get("candidate_folding_audit_hash"),
        "candidate_folding_audit_selection_signal": bundle_verification.get("candidate_folding_audit_selection_signal"),
        "candidate_folding_audit_validated_backend_count": bundle_verification.get("candidate_folding_audit_validated_backend_count"),
        ...
        "recommended_folding_candidate_id": bundle_verification.get("recommended_folding_candidate_id"),
