...
@router.get("/artifacts/data-snapshots/semantic-summary", response_model=ApiResponse)
def data_snapshot_archive_semantic_summary_endpoint(limit: int = 20, verify_files: bool = True) -> ApiResponse:
    return ApiResponse(data=data_snapshot_archive_summary(limit=limit, verify_files=verify_files))
