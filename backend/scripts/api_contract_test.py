...
REQUIRED_PATHS = {
    ...
    "/api/v1/artifacts/data-snapshots/semantic-summary": {"get"},
    ...
    "/api/v1/artifacts/workflow-traces/semantic-summary": {"get"},
    ...
    "/api/v1/resolve-gene": {"post"},
    "/api/v1/fetch-cds": {"post"},
    "/api/v1/evidence/search": {"post"},
    ...
    "/api/v1/rag/status": {"get"},
    "/api/v1/rag/documents": {"get"},
    "/api/v1/rag/ingest-local": {"post"},
    "/api/v1/rag/rebuild": {"post"},
    ...
    "/api/v1/jobs": {"get"},
    "/api/v1/jobs/design-from-gene": {"post"},
    "/api/v1/jobs/batch-design-from-genes": {"post"},
    "/api/v1/jobs/data-refresh": {"post"},
    ...
    "/api/v1/data/refresh": {"post"},
    "/api/v1/data/refresh/validate": {"post"},
    "/api/v1/data/provenance/baseline": {"post"},
    ...
    "/api/v1/data/lockfile/write": {"post"},
